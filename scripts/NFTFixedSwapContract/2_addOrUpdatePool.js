...
async function main() {
  ...
  await sleep(5000);
  await instanceContract.addOrUpdatePool(poolId, addressItem, bUsdAddress, startTime, endTime, startPrice, requireWhitelist, whitelistIds, maxBuyPerAddress, maxBuyPerOrder);
