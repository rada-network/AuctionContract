...
async function main() {
  ...
  await sleep(5000);
  await instanceContract.addOrUpdatePool(poolId, addressItem, bUsdAddress, totalItems, startTime, endTime, startPrice, requireWhitelist, whitelistIds, maxBuyPerAddress);
